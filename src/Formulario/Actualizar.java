...
public class Actualizar extends javax.swing.JFrame {
  ...
  void BuscarEmpleado(String id){
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnGuardar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 420, 100, 40));
    ...
    private void btnGuardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardar1ActionPerformed
        ...
        /*
        sqlEmpleado = "UPDATE Empleado SET empleadoCedula='"+ced+"', empleadoPApellido='"+ap1+"', empleadoSApellido='"+ap2+
        "', empleadoPNombre='"+nom1+"', empleadoSApellido='"+nom2+
        "', empleadoGenero='"+gen+"', empleadoFNacimiento='"+fn+
        "', empleadoDireccion='"+dic+"', empleadoTelefono='"+tel+
        "', empleadoDept='"+dept+"', empleadoCargo='"+car+
        "', empleadoSalario='"+sal+"' WHERE empleadoCodigo='"+txtBuscar1.getText()+"'";
        */

        sqlEmpleado = "UPDATE Empleado SET empleadoNombre=?, empleadoApellido=?, empleadoCedula=?, empleadoGenero=?, empleadoEstadoCivil=?, empleadoDireccion=?,"+
        " empleadoTelefono=?, empleadoPuesto=?,"+
        " empleadoDepartamento=?, empleadoSalario=?,"+
        " empleadoEstado=? WHERE empleadoCodigo='"+txtBuscar1.getText()+"'";
        ...
        */
        try {
            ...
            tablaEmpleado.setString(1, nom1);
            tablaEmpleado.setString(2, ap2);
            tablaEmpleado.setString(3, ced);
            tablaEmpleado.setString(4, gen);
            tablaEmpleado.setString(5, estc);
            tablaEmpleado.setString(6, dic);
            tablaEmpleado.setString(7, tel);
            tablaEmpleado.setString(8, car);
            tablaEmpleado.setString(9, dept);
            tablaEmpleado.setString(10, sal);
            tablaEmpleado.setString(11, statud);
          //  tablaEmpleado.setString(12, fechI);
